...
def login_button_press(ip, user, pwd, vendor, device):
...
login_button = tk.Button(top_frame, text="Connect", fg="white", bg="grey", font=5, command= lambda:login_button_press(ip_value.get(), username_value.get(), password_value.get(), vendor_value.get(), device_var.get()))
