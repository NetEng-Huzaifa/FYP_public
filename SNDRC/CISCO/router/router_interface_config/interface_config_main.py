...
def interface():
    ...
    interface_serial_auth_label = tk.Label(interface_serial_frame, text="Authentication")
    ...
    interface_serial_auth_label.grid(row=1, column=4)
    ...
    interface_serial_auth_value = tk.StringVar()
    ...
    interface_serial_auth_entry = ttk.Combobox(interface_serial_frame, values = ["PAP", "CHAP"], textvariable = interface_serial_auth_value)
    ...
    interface_serial_auth_entry.grid(row=2, column=4, padx=20, pady=10)

    # Buttons Section
    interface_serial_run_button = tk.Button(interface_serial_frame, text="Execute", width=12, command=lambda: serial_interface_config(interface_serial_value.get(), interface_serial_encapsulation_value.get(), interface_serial_clockRate_value.get(), interface_serial_auth_value.get()))
